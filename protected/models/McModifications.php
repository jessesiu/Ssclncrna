...
/**
 * This is the model class for table "mc_modifications".
 *
 * The followings are the available columns in table 'mc_modifications':
 * @property integer $id
 ...
 */
class McModifications extends CActiveRecord
{
    /**
     ...
     * @return McModifications the static model class
     */
